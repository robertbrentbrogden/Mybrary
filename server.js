...
const authorRouter = require('./routes/authors') //creates authorroute into routes authors
...
app.use(bodyParser.urlencoded({ limit: '10mb', extended: false })) //tells app to use bodyparser library specifiy urlencoded increases the file limit size do not extend
...
app.use('/authors', authorRouter) // uses authors route created above
'authors/new'
